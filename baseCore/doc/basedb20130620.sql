...
-- 正在导出表  basedb.qrtz_fired_triggers 的数据：~0 rows (大约)
...
INSERT INTO `qrtz_fired_triggers` (`SCHED_NAME`, `ENTRY_ID`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `INSTANCE_NAME`, `FIRED_TIME`, `PRIORITY`, `STATE`, `JOB_NAME`, `JOB_GROUP`, `IS_NONCONCURRENT`, `REQUESTS_RECOVERY`) VALUES
	('quartzScheduler', 'NON_CLUSTERED1371693625407', 'JOBTEST', '222', 'NON_CLUSTERED', 1371694200000, 5, 'ACQUIRED', NULL, NULL, '0', '0');
...
INSERT INTO `qrtz_triggers` (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `JOB_NAME`, `JOB_GROUP`, `DESCRIPTION`, `NEXT_FIRE_TIME`, `PREV_FIRE_TIME`, `PRIORITY`, `TRIGGER_STATE`, `TRIGGER_TYPE`, `START_TIME`, `END_TIME`, `CALENDAR_NAME`, `MISFIRE_INSTR`, `JOB_DATA`) VALUES
	('quartzScheduler', 'JOBTEST', '222', 'JOBTEST', '222', NULL, 1371694200000, 1371694170000, 5, 'ACQUIRED', 'CRON', 1371694115000, 0, NULL, 0, _binary '');
...
-- 正在导出表  basedb.t_log 的数据：~75 rows (大约)
DELETE FROM `t_log`;
